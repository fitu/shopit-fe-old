...
export const productsReducer = (
    state = {
        loading: false, productCount: 0, resultsPerPage: 0, products: [], error: null,
    },
    action,
) => {
    switch (action.type) {
...
export const newProductReducer = (state = {
    loading: false, success: false, product: {}, error: null,
}, action) => {
    switch (action.type) {
...
export const productReducer = (
    state = {
        loading: false, isDeleted: false, isUpdated: false, product: {}, error: null,
    },
    action,
) => {
    switch (action.type) {
